...
final class UserRepo(val coll: Coll)(implicit ec: scala.concurrent.ExecutionContext) {
  ...
  def getDepString( dep: String) = 
    dep match {
      case "0" => "Aucun"
      case "1" => "Analytique, opérations et technologies de l'information"
      case "2" => "Arts visuels et médiatiques"
      case "3" => "Chimie"
      case "4" => "Communication sociale et publique"
      case "5" => "Danse"
      case "6" => "Design"
      case "7" => "Didactique"
      case "8" => "Didactique des langues"
      case "9" => "Éducation et formation spécialisées"
      case "10" => "Éducation et pédagogie"
      case "11" => "Études internationales de Montréal"
      case "12" => "Études littéraires"
      case "13" => "Études urbaines et touristiques"
      case "14" => "Finance"
      case "15" => "Géographie"
      case "16" => "Histoire"
      case "17" => "Histoire de l'art"
      case "18" => "Informatique"
      case "19" => "Langues"
      case "20" => "Linguistique"
      case "21" => "Management"
      case "22" => "Marketing"
      case "23" => "Mathématiques"
      case "24" => "Media"
      case "25" => "Mode"
      case "26" => "Musique"
      case "27" => "Organisation et ressources humaines"
      case "28" => "Patrimoine"
      case "29" => "Philosophie"
      case "30" => "Psychologie"
      case "31" => "Recherches et études féministes (IREF)"
      case "32" => "Santé et société (ISS)"
      case "33" => "Science politique"
      case "34" => "Sciences biologiques"
      case "35" => "Sciences cognitives (ISC)"
      case "36" => "Sciences comptables"
      case "37" => "Sciences de l'activité physique"
      case "38" => "Sciences de l'environnement (ISE)"
      case "39" => "Sciences de la Terre et de l'atmosphère"
      case "40" => "Sciences des religions"
      case "41" => "Sciences économiques"
      case "42" => "Sciences juridiques"
      case "43" => "Sexologie"
      case "44" => "Sociologie"
      case "45" => "Stratégie, responsabilité sociale et environnementale"
      case "46" => "Théâtre"
      case "47" => "Travail social"
    }
